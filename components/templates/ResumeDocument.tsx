...
export function ResumeDocument({ data, settings, forPrint = false, activeSection }: ResumeDocumentProps) {
  ...
  useEffect(() => {
    ...
    const inTemplateLibrary = Boolean(document.querySelector('.oe-template, .oe-gallery'));
      ...
      {!forPrint && activeSection && (
        <style jsx global>{`
          ...
          #resume-document-root[data-active-section="summary"] [data-resume-section="summary"] {
            ...
            margin-left: -10px;
            margin-right: -10px;
            box-shadow: 0 8px 24px rgba(15, 23, 42, 0.06), 0 0 0 3px rgba(249, 115, 22, 0.055), inset 0 1px 0 rgba(255, 255, 255, 0.72);
          ...
          #resume-document-root[data-active-section="projects"] [data-resume-section="projects"] *,
          #resume-document-root[data-active-section="more"] [data-resume-section="more"] *,
          #resume-document-root[data-active-section="summary"] [data-resume-section="summary"] * { color: #111827 !important; }
        `}</style>
      )}
    </div>
  );
