...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-black/[0.06] bg-white/75 shadow-[0_10px_40px_-30px_rgba(15,23,42,.35)] backdrop-blur-2xl">
        <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between px-5 lg:px-8">
          <Link href="/" className="group shrink-0" aria-label="Orrica Edge home"><img src="/logo-orricaedge.png" alt="Orrica Edge AI Resume Builder" className="h-7 w-auto transition-transform duration-300 group-hover:scale-[1.035] sm:h-8" /></Link>
