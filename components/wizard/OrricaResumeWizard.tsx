...
export function OrricaResumeWizard({ data, settings, updateData, updateSettings, onFinish, finishing }: StepProps & { onFinish: () => void; finishing?: boolean }) {
  ...
  return <div className="oe-resume-wizard h-[100dvh] min-h-[100dvh] overflow-hidden bg-white text-[#111827]">
    ...
    <style jsx global>{`
      ...
      /* Desktop: fixed sidebar + one shared center/right scrollbar. */
      @media(min-width:1101px){
        .oe-resume-layout{display:block!important;min-height:0!important}
        .oe-resume-sidebar{width:238px!important;height:100dvh!important}
        .oe-resume-workspace{margin-left:238px!important;height:100dvh!important;overflow-y:auto!important;overflow-x:hidden!important}
        .oe-resume-workspace-content{display:grid!important;grid-template-columns:minmax(0,1fr) 400px!important;align-items:start!important;min-width:0!important;min-height:max-content!important}
        .oe-resume-form{overflow:visible!important;min-height:max-content!important}
        .oe-resume-form>div{display:block!important;height:auto!important;min-height:0!important}
        .oe-resume-form-scroll{overflow:visible!important;min-height:0!important;height:auto!important;flex:none!important}
        .oe-resume-actions{height:70px!important}
        .oe-resume-preview{overflow:visible!important;min-height:max-content!important;height:auto!important}
      }

      /* Tablet: preserve the current two-panel workspace where practical, with a single shared scroll context. */
      @media(max-width:1100px) and (min-width:901px){
        .oe-resume-sidebar{position:fixed!important;inset:0 auto 0 0!important;width:210px!important;height:100dvh!important;overflow:hidden!important;z-index:40}
        .oe-resume-layout{display:block!important;min-height:0!important}
        .oe-resume-workspace{margin-left:210px!important;height:100dvh!important;overflow-y:auto!important;overflow-x:hidden!important}
        .oe-resume-workspace-content{display:grid!important;grid-template-columns:minmax(0,1fr) 330px!important;align-items:start!important;min-height:max-content!important}
        .oe-resume-form{overflow:visible!important;min-height:max-content!important}
        .oe-resume-form>div{display:block!important;height:auto!important;min-height:0!important}
        .oe-resume-form-scroll{overflow:visible!important;height:auto!important;min-height:0!important;flex:none!important}
        .oe-resume-preview{overflow:visible!important;height:auto!important;min-height:max-content!important}
        .oe-resume-form>div:first-child{padding-left:24px!important;padding-right:24px!important}
      }

      /* Mobile: keep the existing single-column mobile experience and make only the form area scroll. */
      @media(max-width:900px){
        .oe-resume-wizard{height:100dvh!important;min-height:100dvh!important}
        .oe-resume-sidebar,.oe-resume-preview{display:none!important}
        .oe-resume-workspace{margin-left:0!important;height:100dvh!important;overflow:hidden!important}
        .oe-resume-header{height:64px!important}
        ...
        .oe-resume-form{height:100%!important;min-height:0!important;display:flex!important;flex-direction:column!important;overflow:hidden!important}
        .oe-resume-form>div{display:flex!important;flex-direction:column!important;height:100%!important;min-height:0!important}
        .oe-resume-form-scroll{display:block!important;flex:1 1 auto!important;min-height:0!important;height:auto!important;overflow-y:auto!important;overflow-x:hidden!important;padding:52px 16px 20px!important}
        .oe-resume-actions{height:64px!important;min-height:64px!important;flex-shrink:0!important;padding:8px 12px!important}
        .oe-resume-actions>div{max-width:none!important}
        .oe-resume-actions button{min-width:0!important}
        .oe-resume-header img{height:25px!important}
        .oe-resume-workspace-content>main h1{font-size:25px!important}
        .oe-resume-wizard:after{content:"";position:absolute;left:14px;right:14px;top:72px;height:4px;border-radius:999px;background:#f0f1f2;pointer-events:none}
      }

      @media(max-width:560px){
        .oe-resume-header{padding-left:13px!important;padding-right:13px!important}
        .oe-resume-header img{height:24px!important}
        .oe-resume-form-scroll{padding-left:13px!important;padding-right:13px!important}
        .oe-resume-workspace-content>main h1{font-size:24px!important}
        .oe-resume-actions{padding-left:10px!important;padding-right:10px!important}
        .oe-resume-actions button{padding-left:12px!important;padding-right:12px!important;font-size:12px!important}
      }
    `}</style>
  </div>;
}
