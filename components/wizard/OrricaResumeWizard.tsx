...
export function OrricaResumeWizard({ data, settings, updateData, updateSettings, onFinish, finishing }: StepProps & { onFinish: () => void; finishing?: boolean }) {
  ...
  return <div className="oe-resume-wizard h-[100dvh] min-h-[100dvh] overflow-hidden bg-white text-[#111827]">
    ...
    <style jsx global>{`
      ...
      @media(max-width:1100px) and (min-width:901px){.oe-resume-sidebar{width:210px!important}.oe-resume-workspace{margin-left:210px!important}.oe-resume-workspace-content{grid-template-columns:minmax(0,1fr) 330px!important}.oe-resume-workspace main>div:first-child{padding-left:24px!important;padding-right:24px!important}}
      @media(max-width:900px){.oe-resume-sidebar{display:none!important}.oe-resume-workspace{margin-left:0!important;height:100dvh!important;overflow-y:hidden!important}.oe-resume-workspace>header{height:64px!important}.oe-resume-workspace-content{display:flex!important;flex-direction:column!important;height:calc(100dvh - 64px)!important;min-height:0!important}.oe-resume-workspace-content>aside{display:none!important}.oe-resume-workspace-content>main{height:100%!important;min-height:0!important;display:flex!important;flex-direction:column!important;overflow:hidden!important}.oe-resume-workspace-content>main>div:first-child{min-height:0!important;flex:1!important;overflow-y:auto!important;overflow-x:hidden!important;padding:52px 16px 20px!important}.oe-resume-workspace-content>main>div:last-child{height:64px!important;flex-shrink:0!important;padding:8px 12px!important}.oe-resume-wizard main h1{font-size:25px!important}.oe-resume-wizard:after{content:"";position:absolute;left:14px;right:14px;top:72px;height:4px;border-radius:999px;background:#f0f1f2;box-shadow:inset 0 0 0 0 #f47c3c;pointer-events:none}.oe-resume-wizard input,.oe-resume-wizard textarea,.oe-resume-wizard select{font-size:16px!important}}
      @media(max-width:560px){.oe-resume-workspace>header{padding-left:13px!important;padding-right:13px!important}.oe-resume-workspace>header img{height:24px!important}.oe-resume-workspace-content>main>div:first-child{padding-left:13px!important;padding-right:13px!important}.oe-resume-wizard main h1{font-size:24px!important}.oe-resume-workspace-content>main>div:last-child{padding-left:10px!important;padding-right:10px!important}.oe-resume-workspace-content>main>div:last-child button{min-width:0!important;padding-left:12px!important;padding-right:12px!important;font-size:12px!important}}
    `}</style>
  </div>;
}
