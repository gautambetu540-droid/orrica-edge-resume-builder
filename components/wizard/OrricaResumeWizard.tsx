...
export function OrricaResumeWizard({ data, settings, updateData, updateSettings, onFinish, finishing }: StepProps & { onFinish: () => void; finishing?: boolean }) {
  ...
  return <div className="oe-resume-wizard h-[100dvh] min-h-[100dvh] overflow-hidden bg-white text-[#111827]">
    ...
    <style jsx global>{`
      ...
      /* Desktop/tablet: one authoritative scroll container. */
      @media(min-width:901px){
        .oe-resume-layout{position:relative;overflow-y:auto;overflow-x:hidden;height:calc(100dvh - 64px);align-items:start}
        .oe-resume-sidebar{position:fixed;left:0;top:64px;bottom:0;width:238px;z-index:40}
        .oe-resume-form{overflow:visible!important;height:auto!important;min-height:calc(100dvh - 64px)}
        .oe-resume-form>div{display:block!important;height:auto!important;min-height:0!important}
        .oe-resume-form-scroll{overflow:visible!important;height:auto!important;min-height:0!important}
        .oe-resume-actions{height:70px!important}
        .oe-resume-preview{overflow:visible!important;height:auto!important}
        .oe-resume-preview .flex.min-h-0.flex-col{height:auto!important;min-height:0!important}
        .oe-resume-preview .rounded-xl{flex:none!important}
      }

      @media(max-width:1100px) and (min-width:901px){
        .oe-resume-sidebar{width:210px!important}
        .oe-resume-layout{grid-template-columns:210px minmax(0,1fr) 330px!important}
        .oe-resume-form-scroll{padding-left:24px!important;padding-right:24px!important}
      }

      /* Mobile: preserve the existing mobile UI, with only the page itself scrolling. */
      @media(max-width:900px){
        .oe-resume-layout{display:flex!important;flex-direction:column!important;height:calc(100dvh - 64px)!important;min-height:0!important;overflow:hidden!important}
        .oe-resume-sidebar,.oe-resume-preview{display:none!important}
        .oe-resume-form{height:100%!important;min-height:0!important;overflow:hidden!important}
        .oe-resume-form>div{height:100%!important;min-height:0!important;display:flex!important;flex-direction:column!important}
        .oe-resume-form-scroll{min-height:0!important;flex:1!important;overflow-y:auto!important;overflow-x:hidden!important;padding:52px 16px 20px!important}
        .oe-resume-actions{height:64px!important;flex-shrink:0!important;padding:8px 12px!important}
      ...
      @media(max-width:560px){
        ...
        .oe-resume-wizard h1{font-size:24px!important}
        .oe-resume-actions{padding-left:10px!important;padding-right:10px!important}
        .oe-resume-actions button{min-width:0!important;padding-left:12px!important;padding-right:12px!important;font-size:12px!important}
      }
    `}</style>
  </div>;
}
