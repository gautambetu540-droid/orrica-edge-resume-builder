...
const SUBTITLES = [
  ...
  'Give employers a quick overview of your experience and strengths.', 'Review the live resume and make any final changes before downloading.',
];
