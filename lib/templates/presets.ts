...
): TemplatePreset => ({ id, name, category: options.layout === 'two-column' ? 'Two Column' : 'Single Column', ...options });

const BASE_TEMPLATE_PRESETS: Record<string, TemplatePreset> = {
  'modern-ats': preset('modern-ats', 'Modern ATS', { layout: 'single-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'plain', sectionHeadingStyle: 'uppercase-accent', dividers: true, photoAllowed: false, defaultAccentColor: '#2563EB', recommendedFont: 'arial', defaultFontSize: 10.2, defaultHeadingScale: 1.08, defaultLineSpacing: 1.28, defaultSectionSpacing: 13, defaultMargin: 15, description: 'Clean recruiter-first structure with strong ATS readability.' }),
  ...
  'modern-two-column': preset('modern-two-column', 'Modern Two Column', { layout: 'two-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'solid', sectionHeadingStyle: 'uppercase-accent', dividers: false, photoAllowed: false, defaultAccentColor: '#0891B2', recommendedFont: 'arial', defaultFontSize: 10.2, defaultHeadingScale: 1.08, defaultLineSpacing: 1.28, defaultSectionSpacing: 15, defaultMargin: 0, description: 'High-impact two-column layout with a confident sidebar.' }),
  'fresh-graduate': preset('fresh-graduate', 'Fresh Graduate', { layout: 'single-column', headerAlign: 'left', headerVariant: 'editorial', sidebarVariant: 'plain', sectionHeadingStyle: 'uppercase-accent', dividers: true, photoAllowed: false, defaultAccentColor: '#16A34A', recommendedFont: 'proxima-nova', defaultFontSize: 10.3, defaultHeadingScale: 1.1, defaultLineSpacing: 1.28, defaultSectionSpacing: 14, defaultMargin: 15, description: 'Education-forward structure for students and early-career candidates.' }),
  ...
  'elegant-serif': preset('elegant-serif', 'Elegant Serif', { layout: 'single-column', headerAlign: 'left', headerVariant: 'editorial', sidebarVariant: 'plain', sectionHeadingStyle: 'small-caps-line', dividers: true, photoAllowed: false, defaultAccentColor: '#7C3AED', recommendedFont: 'times-new-roman', defaultFontSize: 10.3, defaultHeadingScale: 1.08, defaultLineSpacing: 1.3, defaultSectionSpacing: 14, defaultMargin: 16, description: 'Refined editorial serif design with balanced page rhythm.' }),
  'compact-ats': preset('compact-ats', 'Compact ATS', { layout: 'single-column', headerAlign: 'left', headerVariant: 'compact', sidebarVariant: 'plain', sectionHeadingStyle: 'bold-plain', dividers: true, photoAllowed: false, defaultAccentColor: '#334155', recommendedFont: 'ibm-plex-sans', defaultFontSize: 9.6, defaultHeadingScale: 1.02, defaultLineSpacing: 1.2, defaultSectionSpacing: 9, defaultMargin: 13, description: 'Dense but readable one-page format for detailed experience.' }),
  'creative-sidebar': preset('creative-sidebar', 'Creative Sidebar', { layout: 'two-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'soft', sectionHeadingStyle: 'uppercase-underline', dividers: true, photoAllowed: true, defaultAccentColor: '#DB2777', recommendedFont: 'arial', defaultFontSize: 10.1, defaultHeadingScale: 1.06, defaultLineSpacing: 1.24, defaultSectionSpacing: 13, defaultMargin: 0, description: 'Distinctive two-column profile with a light creative sidebar.' }),
  'clean-corporate': preset('clean-corporate', 'Clean Corporate', { layout: 'single-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'plain', sectionHeadingStyle: 'bold-plain', dividers: true, photoAllowed: false, defaultAccentColor: '#2563EB', recommendedFont: 'inter', defaultFontSize: 10.2, defaultHeadingScale: 1.08, defaultLineSpacing: 1.27, defaultSectionSpacing: 13, defaultMargin: 15, description: 'Straightforward corporate resume with crisp modern spacing.' }),
  'tech-modern': preset('tech-modern', 'Tech Modern', { layout: 'two-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'solid', sectionHeadingStyle: 'uppercase-accent', dividers: false, photoAllowed: false, defaultAccentColor: '#06B6D4', recommendedFont: 'ibm-plex-sans', defaultFontSize: 10, defaultHeadingScale: 1.07, defaultLineSpacing: 1.25, defaultSectionSpacing: 13, defaultMargin: 0, description: 'Technical two-column layout designed for product and engineering roles.' }),
  'simple-chronological': preset('simple-chronological', 'Simple Chronological', { layout: 'single-column', headerAlign: 'left', headerVariant: 'compact', sidebarVariant: 'plain', sectionHeadingStyle: 'uppercase-underline', dividers: true, photoAllowed: false, defaultAccentColor: '#64748B', recommendedFont: 'arial', defaultFontSize: 10.1, defaultHeadingScale: 1.05, defaultLineSpacing: 1.25, defaultSectionSpacing: 12, defaultMargin: 15, description: 'Classic reverse-chronological structure with clear section rules.' }),
  ...
  'creative-modern': preset('creative-modern', 'Creative Modern', { layout: 'two-column', headerAlign: 'center', headerVariant: 'centered', sidebarVariant: 'soft', sectionHeadingStyle: 'uppercase-accent', dividers: false, photoAllowed: true, defaultAccentColor: '#8B5CF6', recommendedFont: 'proxima-nova', defaultFontSize: 10.2, defaultHeadingScale: 1.1, defaultLineSpacing: 1.28, defaultSectionSpacing: 14, defaultMargin: 0, description: 'Contemporary visual hierarchy for creative and marketing profiles.' }),
  ...
  'timeline-pro': preset('timeline-pro', 'Timeline Pro', { layout: 'two-column', headerAlign: 'left', headerVariant: 'clean', sidebarVariant: 'plain', sectionHeadingStyle: 'bold-plain', dividers: true, photoAllowed: false, defaultAccentColor: '#0EA5E9', recommendedFont: 'source-sans-3', defaultFontSize: 10.1, defaultHeadingScale: 1.07, defaultLineSpacing: 1.26, defaultSectionSpacing: 13, defaultMargin: 0, description: 'Structured two-column presentation with a strong career progression feel.' }),
};

const generatedPresets: Record<string, TemplatePreset> = {};
const addGenerated = (id: string, name: string, category: string, accent: string, font: ResumeFont, photoAllowed = false, layout: TemplateLayout = 'single-column') => {
  generatedPresets[id] = preset(id as TemplateId, name, {
    layout,
    headerAlign: layout === 'two-column' ? 'left' : 'left',
    headerVariant: layout === 'two-column' ? 'clean' : 'compact',
    sidebarVariant: layout === 'two-column' ? 'soft' : 'plain',
    sectionHeadingStyle: 'uppercase-accent',
    dividers: true,
    photoAllowed,
    defaultAccentColor: accent,
    recommendedFont: font,
    defaultFontSize: 10.1,
    defaultHeadingScale: 1.06,
    defaultLineSpacing: 1.25,
    defaultSectionSpacing: 12,
    defaultMargin: layout === 'two-column' ? 0 : 15,
    description: `${category} resume with a clean, recruiter-friendly hierarchy and customizable styling.`,
  });
};

const fresherColors = ['#2563EB', '#0F766E', '#16A34A', '#7C3AED', '#0891B2', '#4F46E5', '#0D9488', '#475569', '#1D4ED8', '#15803D'];
const photoColors = ['#7C3AED', '#DB2777', '#0F766E', '#2563EB', '#0891B2', '#C2410C', '#4F46E5', '#0E7490', '#9333EA', '#15803D'];
const itColors = ['#2563EB', '#0891B2', '#0F766E', '#4F46E5', '#0284C7', '#334155', '#0369A1', '#0E7490', '#1D4ED8', '#166534'];
const bpoColors = ['#0F766E', '#2563EB', '#7C3AED', '#0891B2', '#16A34A', '#4F46E5', '#DB2777', '#0E7490', '#15803D', '#1D4ED8'];

for (let i = 1; i <= 10; i += 1) {
  const n = String(i).padStart(2, '0');
  addGenerated(`fresher-${n}`, `Fresher ${i}`, 'Fresher', fresherColors[i - 1], i % 3 === 0 ? 'source-sans-3' : 'proxima-nova');
  addGenerated(`photo-${n}`, `Photo Resume ${i}`, 'Photo Resume', photoColors[i - 1], i % 2 === 0 ? 'inter' : 'proxima-nova', true, i % 3 === 0 ? 'two-column' : 'single-column');
  addGenerated(`it-${n}`, `IT / Technology ${i}`, 'IT / Technology', itColors[i - 1], i % 2 === 0 ? 'ibm-plex-sans' : 'inter', false, i % 2 === 0 ? 'two-column' : 'single-column');
  addGenerated(`bpo-${n}`, `BPO / Customer Support ${i}`, 'BPO / Customer Support', bpoColors[i - 1], i % 2 === 0 ? 'arial' : 'source-sans-3');
}

export const TEMPLATE_PRESETS: Record<TemplateId, TemplatePreset> = {
  ...BASE_TEMPLATE_PRESETS,
  ...generatedPresets,
} as Record<TemplateId, TemplatePreset>;
